...
extern "C" {
    ...
    pub fn atomics_wait_timeout_ms_try(timeout_ms: f64) -> JsValue;
    pub fn yield_to_event_loop() -> js_sys::Promise;
    pub fn sleep_sync_ms(ms: f64);
    pub fn get_available_parallelism() -> u32;
    pub fn park_wait_at_addr(memory: &JsValue, ptr: u32) -> JsValue;
    pub fn park_wait_timeout_at_addr(memory: &JsValue, ptr: u32, timeout_ms: f64) -> JsValue;
    pub fn park_notify_at_addr(memory: &JsValue, ptr: u32);
}
